...
\ecvitem[10pt]{\large Capacit\`a e competenze tecniche}{La maggior
  ...
  sia il linguaggio TSQL ed in maggior misure \emph{PostgreSQL}, 
  ...
  discussa nel volume \emph{The Seasoned Schemer})
}
...
\ecvitem[10pt]{\large Capacit\`a e competenze informatiche}{ Durante i
  ...
  studiando i libri di Raymond Smullyan. Inoltre durante il lavoro
  della seconda tesi, ho trovato interesse nell'interpretazioni combinatorie
...
\ecvitem{}{Sono interessato agli argomenti trattati in Informatica
  Teorica e alla pratica del \emph{Judo}}
