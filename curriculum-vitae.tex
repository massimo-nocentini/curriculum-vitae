...
\ecvemail{\url{massimo.nocentini@gmail.com}\quad\url{massimo.nocentini@stud.unifi.it}}
...
\ecvitem{Date}{\textbf{da 14/07/2015 a 16/07/2015  }}
\ecvitem{Evento}{Second International Symposium on Riordan Arrays and Related Topics}
...
\ecvitem{Principali materie/Competenze professionali
  apprese}{theoretical computer science, discrete mathematics}
\ecvitem{Nome e tipo d'istituto di istruzione o formazione}{
    Universit\`a degli Studi di Firenze, facolt\`a di Scienze Matematiche Fisiche e Naturali}
\\
...
\ecvitem[10pt]{\large Capacit\`a e competenze tecniche}{La maggior
  ...
  si avvalgono di un database come supporto di memoria ed ho potuto
...
\ecvitem[10pt]{\large Capacit\`a e competenze informatiche}{ Durante i
  ...
  studiando i libri di Smullyan. Inoltre ho seguito per interesse
